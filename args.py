...
def parse_args_bayesian_test():
    ...
    parser.add_argument('--pos_empiric_probs', type=str, default=None,
                        help='file with pos empiric probs')

    parser.add_argument('--neg_empiric_probs', type=str, default=None,
                        help='file with pos empiric probs')
